...
import eu.vranckaert.poc.barcode.BuildConfig;
...
public final class ViewfinderView extends View {
    ...
    private boolean drawScanningResultPoints = BuildConfig.DEBUG; // Enable or disable the dots indicating the matching points a barcode
    ...
    public void onDraw(Canvas canvas) {
        ...
        // Change the scanning frame boundaries here
